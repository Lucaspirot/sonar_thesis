...
NewPing sonar[SONAR_NUM] = {     // Sensor object array.
  NewPing(1, 1, MAX_DISTANCE), // Each sensor's trigger pin, echo pin, and max distance to ping.
  NewPing(2, 2, MAX_DISTANCE),
  NewPing(3, 3, MAX_DISTANCE),
  NewPing(4, 4, MAX_DISTANCE),
  NewPing(5, 5, MAX_DISTANCE)
  
//  NewPing(11, 11, MAX_DISTANCE),    -> Just add lines as soon as there are more than 5 sensors
